...
class BudgetTests(unittest.TestCase):
    ...
    def test_published_menu_arithmetic_and_optional_defaults(self):
        ...
        self.assertEqual(items['higuma']['cents'], 2 * 1500 + 2 * 250)
        ...
        self.assertEqual(included, {'evolution', 'pleincoeur'})
